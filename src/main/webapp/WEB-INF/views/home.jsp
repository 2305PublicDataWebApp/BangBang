			    ...
			    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
			        ...
			        <c:forEach items="${bList }" var="banner">
			        	<div id="main-banner" class="carousel-item active">
			                <a href="${banner.linkUrl }" target="_blank" ><img class="banner-img" src="${banner.bannerFilePath }" class="d-block w-100" alt="메인배너"></a>
			            </div>
			        </c:forEach>
<!-- 			            <div id="main-banner" class="carousel-item active"> -->
...
<!-- 			            </div> -->
            ...
            <main class="main-container">
                ...
                <div id="event">
                    <div id="carouselExampleIndicators-event" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#carouselExampleIndicators-event" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
			            	<button type="button" data-bs-target="#carouselExampleIndicators-event" data-bs-slide-to="1" aria-label="Slide 2"></button>
			            	<button type="button" data-bs-target="#carouselExampleIndicators-event" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        </div>
                        <div class="carousel-inner">
							<c:forEach items="${tbList }" var="trip_banner">
					        	<div id="event-banner" class="carousel-item active">
					                <a href="${trip_banner.linkUrl }" target="_blank" ><img class="banner-img" src="${trip_banner.bannerFilePath }" class="d-block w-100" alt="이벤트배너"></a>
					            </div>
					        </c:forEach>                        
<!--                             <div id="event-banner" class="carousel-item active"> -->
...
<!--                             </div> -->
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators-event" data-bs-slide="prev">
			            	<span class="carousel-control-prev-icon" aria-hidden="true"></span>
			           		<span class="visually-hidden">Previous</span>
				        </button>
				        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators-event" data-bs-slide="next">
				            <span class="carousel-control-next-icon" aria-hidden="true"></span>
				            <span class="visually-hidden">Next</span>
				        </button>
                    </div>
