...
<div class="menu-box">
	<div class="menu-box-top">
		...
		<!-- 개인 정보 조회 -->
		<div class="menu-info">
			<a href="/user/info.do?userId=${ userId }"><img class="menu-icon" src="/resources/images/user/info.png" alt="개인 정보 조회"></a><br>
		...
		<form action="/user/modify.do" method="post">
			<div class="menu-info-modify">
				<a href="/user/check_pw.do?userId=${ userId }"><img class="menu-icon" src="/resources/images/user/modify.png" alt="개인 정보 수정"></a><br>
	...
	<div class="menu-box-bottom">
		...
		<div class="menu-info-board">
		    <a href="/user/my_board.do?userId=${ userId }"><img class="menu-icon" src="/resources/images/user/board.png" alt="내 게시글 조회"></a><br>
