		...
		<div class="center">
			...
			<div class="mainsearch">
				<form action="/review/r_search.do" method="get">
					...
					</select> <input class="searchtext" type="text" name="searchKeyword"
						placeholder="검색어를 입력하세요." value="${searchKeyword }"> <input
						class="clicksearch" type="submit" value="검색">
				</form>
			</div>
			<hr>
				...
				<tbody>
					<c:forEach var="review" items="${rList }" varStatus="i">
						<tr>
							...
							<td><a
								href="/review/r_detail.do?reviewNo=${review.reviewNo }">${review.reviewTitle }</a></td>
			...
			<div class="paging">
				...
				<c:forEach begin="${rInfo.rStartNavi }" end="${rInfo.rEndNavi }"
					var="r">
